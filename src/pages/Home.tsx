        ...
        {showModal && (
          <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4">
            <motion.div 
              ...
              animate={{ opacity: 1 }}
              exit={{ opacity: 0 }}
              className="absolute inset-0 bg-primary-text/60 backdrop-blur-md" 
            ...
            <motion.div 
              ...
              className="bg-white w-full max-w-2xl rounded-[32px] p-6 md:p-10 relative z-10 shadow-2xl overflow-hidden flex flex-col max-h-[85vh]"
            >
              <h3 className="text-2xl font-black mb-6 text-primary-text uppercase tracking-tight shrink-0">Kết quả cho: {phone}</h3>
              ...
              <button 
                onClick={() => setShowModal(false)} 
                className="w-full mt-6 py-4 bg-accent-pink text-white rounded-2xl font-black uppercase tracking-widest shadow-lg shrink-0 hover:bg-rose-600 transition-colors"
              >
                Đóng
              </button>
            </motion.div>
